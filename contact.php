...
<div class="col s6 ">
<div class="card-panel black white-text center"><h6>Developed By</h6></div>
</div>
</div>
...
<div class="row">
  <div class="column">
    <div class="card">
      <img src="img/kirti.jpg" alt="Jane" style="width:100%">
      <div class="container">
        <h4>Kirti Patil</h4>
        <p class="title">BE Computer</p>
    
        <p><a href="https://www.instagram.com/ll_million__dreamer_ll/" class="button">Contact</a></p>
      </div>
    </div>
  </div>
